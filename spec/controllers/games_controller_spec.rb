  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved game as @game" do
        ...
        post :create, {:game => { "location" => "invalid value" }}, valid_session
        assigns(:game).should be_a_new(Game)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested game" do
        ...
        Game.any_instance.should_receive(:update_attributes).with({ "location" => "MyString" })
        put :update, {:id => game.to_param, :game => { "location" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the game as @game" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Game.any_instance.stub(:save).and_return(false)
        put :update, {:id => game.to_param, :game => { "location" => "invalid value" }}, valid_session
        assigns(:game).should eq(game)
      end
